...
window.onload = function createState() {
    for(let i = 1;i<=8;i++){
        for(let j = 1;j<=8;j++) {
            let sateImage = document.getElementById('img');
			//点击事件
            sateImage.addEventListener('click', function getState() {
                ...
                document.getElementById(select).src = "F:\\VM8\\Mxonline3-master\\media\\image1\\select.png"
                //console.log(row, col);
            });
            ...
            change.onclick = function changeState() {
                ...
                if(value == 'active'){
                    array[row-1][col-1] = 0;
                    newState.src = 'F:\\VM8\\Mxonline3-master\\media\\image1\\seat.png';
                    console.log('active');
                }
                else if(value == 'broken'){
                    array[row-1][col-1] = -1;
                    newState.src = 'F:\\VM8\\Mxonline3-master\\media\\image1\\broken.png';
                    ...
                    array[row-1][col-1] = 2;
                    newState.src = 'F:\\VM8\\Mxonline3-master\\media\\image1\\aisle.png';
                    console.log('aisle');
                }
             }
        }
